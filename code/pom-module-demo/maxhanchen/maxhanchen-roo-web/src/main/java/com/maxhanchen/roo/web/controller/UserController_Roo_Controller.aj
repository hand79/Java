...
import com.maxhanchen.roo.web.controller.UserController;
...
privileged aspect UserController_Roo_Controller {
    ...
    void UserController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("user_createtime_date_format", "yyyy-MM-dd HH:mm:ss");
        uiModel.addAttribute("user_updatetime_date_format", "yyyy-MM-dd HH:mm:ss");
    }
