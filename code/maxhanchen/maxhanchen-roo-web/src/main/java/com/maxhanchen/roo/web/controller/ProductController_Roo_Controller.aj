...
import com.maxhanchen.roo.web.controller.ProductController;
...
privileged aspect ProductController_Roo_Controller {
    ...
    void ProductController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("product_createtime_date_format", "yyyy-MM-dd HH:mm:ss");
        uiModel.addAttribute("product_updatetime_date_format", "yyyy-MM-dd HH:mm:ss");
    }
